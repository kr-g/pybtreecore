...
`pybtreecore` provides core methods for persisting a `BTree Node` - 
as described here [B-Tree/B+Tree/B*Tree](https://en.wikipedia.org/wiki/B-tree) -
in a `heapfile` / `dllfile`.
